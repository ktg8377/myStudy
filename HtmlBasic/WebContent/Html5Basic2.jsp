...
<body>
	...
	<form>
		<fieldset>
			<legend>
				...
				<p>
					<label for="number">
						...
						max="10" step="2" value="1" id="number" />
				</p>
				<p>
				<label for="range">만족도 : </label><input type="range" min="1"
			...
			<p>
				<label for="datetime">날짜시간(UTC) : </label><input type="datetime"
					id="datetime" />
			</p>
			<p>
				<label for="datetime-local">날짜시간 : </label><input
			...
			<p>
				<label for="btn">서브밋 : </label>
					<input type="submit" id="btn" value="전달 버튼" />
			</p>
		</fieldset>
	</form>
